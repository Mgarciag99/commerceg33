        ...
        <div class="container">
            <div class="main">
                ...
                <div class="main-content">
                    <h2 class="title t-underline">Visualizaci&oacute;n de Pedido</h2>
                    ...
                    <button class="button-item button-medium" onclick="confirmOrder();" <i class="fas fa-folder-open"></i> Confirmar Pedido</button>
                </div>
            </div>
